...
export const  BehanceIcon = ({className, ...rest}) => (
    ...
    >
      ...
      <path
        fill="#FFF"
        d="M27 17h7v2h-7zm-5.488 6.428c.585-.285 1.903-.934 1.903-2.857 0-3.617-3.952-3.57-4.683-3.57H12v14h7.025C19.61 31 24 30.835 24 26.999c0-2.475-1.61-3.285-2.488-3.571zm-6.512-4h2.928c.292 0 2.195.104 2.195 1.572 0 1.467-1.463 1.714-1.902 1.714H15v-3.286zm3.336 9.143h-3.367v-3.856h3.367c.731 0 2.341.237 2.341 2 0 1.761-2.049 1.856-2.341 1.856zm14.102-.176a2.753 2.753 0 0 1-1.549.436c-2.326 0-2.789-1.961-2.789-2.83H36c0-.869 0-1.511-.155-2.236C35.689 23.04 34.63 20 30.734 20 25.289 20 25 24.778 25 25.5c0 .723.156 1.593.467 2.171.309.724.619 1.304 1.084 1.736a6.87 6.87 0 0 0 1.703 1.157 6.564 6.564 0 0 0 2.324.436c1.238 0 2.324-.288 3.253-.868.931-.579 1.55-1.448 2.014-2.606h-2.633c-.155.29-.31.578-.774.869zm-1.704-6.368c1.518 0 2.168 1.592 2.322 2.314H28.1c0-.143.371-2.314 2.634-2.314z"
      />
    </svg>
  );
