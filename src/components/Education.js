...
import LiIcon from './LiIcon'; // Ensure that LiIcon is properly defined
...
const Details = ({ type, time, place, info }) => {
  ...
  return (
    <li
      ref={ref}
      className="my-8 first:mt-10 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between md:w-[80%]"
    >
...
const Education = () => {
  ...
  const { scrollYProgress } = useScroll({
    target: ref,
    offset: ['start end', 'center start'], // Proper offset values for scroll effect
  });
