          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                img={project1}
                summary="A feature-rich Crypto Screener App using React, Tailwind CSS, Context API, React Router, and Recharts. It shows details regarding almost all the cryptocurrencies, and you can easily convert the price into your local currency."
                link="/"
                github="https://github.com/yourusername/crypto-screener"
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Project 1"
                img={project1} // Replace with actual image
            ...
            <div className="col-span-12">
              <FeaturedProject
                ...
                img={project1} // Replace with actual image
                summary="A feature-rich Crypto Screener App using React, Tailwind CSS, Context API, React Router, and Recharts. It shows details regarding almost all the cryptocurrencies, and you can easily convert the price into your local currency."
                link="/another-featured-project"
                github="https://github.com/yourusername/another-featured-project"
                type="Featured Project"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Project 3"
                img={project1} // Replace with actual image
                summary="Description of project 3"
                link="/project3"
