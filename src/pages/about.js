...
import profilePic  from "../../public/images/profile/Screenshot_20181014_191150.png"
...
every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.
            ...
            '>
                ...
                <Image src={profilePic} alt="Yogesh Raj" className='w-full h-auto rounded-2xl'
                priority
            ...
            <div className='flex flex-col items-end justify-center xl:items-center'>
                ...
                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base
                xs:text-sm'> Months of Experience</h2>
            </div>
            </div> 
        </div>
        <Skills/>
